...
namespace Gamu2059.hlsl_grimoire.ch14
{
    public class CustomCh14Property
    {
        ...
        public static readonly ShaderTagId DeferredLightingTag = new ShaderTagId("CustomCh14DeferredLighting");
        
        public static readonly int PreDepthTexId = Shader.PropertyToID("_PreDepthTex");
        public static readonly int ShadowColorTexId = Shader.PropertyToID("_ShadowColorTex");
        ...
        public static readonly RenderTargetIdentifier ShadowColorTex = new RenderTargetIdentifier(ShadowColorTexId);
        ...
        public static readonly RenderTargetIdentifier GBufferDepth = new RenderTargetIdentifier(GBufferDepthTexId);
